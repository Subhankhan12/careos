...
3. **`DECISIONS.md`** — architecture decision log, **D-001 → D-155** (append-only; never edit past entries; **D-149**
...
5. **`memory/LOG.md`** — one line per completed gate; the full build history (Phases 0/A–G · P0P · CLINIC.W1–W10 ·
   ...
   AGENT.P1–6 · ALLERGY.P1 · BILLAR.P1–7 · ARDETAIL.P1–6 · APPT.P1] · the reconciliation entries).
