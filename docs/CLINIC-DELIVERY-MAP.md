...
> (W8/W8b/W8c/W9/W10) and the DENTAL vertical (G1–G9). For CURRENT status read **`PROJECT-STATE.md`**
> (authoritative snapshot) and **`docs/MASTER-STATUS-REPORT.md`** (authoritative status + gap audit at
> HEAD; supersedes `docs/FEATURE-INVENTORY.md`). Keep this file for the screen→backend mapping
