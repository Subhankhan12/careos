...
> Pest **1123 passed** (+5 from BILLAR.P5), PHPStan L5 `[OK]`, Pint clean; `composer test:smoke`
> green; CI green on MySQL 8; the FIX.5 route-smoke guards against request-time 500s. (Latest commit: BILLAR.P5.)
>
