...
> Pest **1100 passed** (+7 from BILLAR.P1), PHPStan L5 `[OK]`, Pint clean; `composer test:smoke`
> green; CI green on MySQL 8; the FIX.5 route-smoke guards against request-time 500s. (Latest commit: BILLAR.P1.)
>
