...
> Pest **1144 passed** (+5 from ARDETAIL.P2), PHPStan L5 `[OK]`, Pint clean; npm build green; `composer test:smoke`
> green; CI green on MySQL 8; the FIX.5 route-smoke guards against request-time 500s. (Latest commit: ARDETAIL.P2 — the AR Account Detail dunning timeline; AR Account Detail drill-in: P1 ledger + P2 dunning timeline done.)
>
