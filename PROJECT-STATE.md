...
> Pest **1139 passed** (+5 from ARDETAIL.P1), PHPStan L5 `[OK]`, Pint clean; npm build green; `composer test:smoke`
> green; CI green on MySQL 8; the FIX.5 route-smoke guards against request-time 500s. (Latest commit: ARDETAIL.P1 — the AR Account Detail per-account running-balance ledger; Billing & AR page complete, now building the drill-in.)
>
